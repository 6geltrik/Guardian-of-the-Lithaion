...
Προγραμματίζουμε το MPU6050 και κάνουμε δοκιμές καλής λειτουργίας. Δηλαδή αν οι γωνίες που παίρνουμε από τον αισθητήρα ανταποκρίνονται πραγματικά. και μετά σε συνδυασμό με τον αισθητήρα υπερήχων που μετρά την απόσταση από την ακτή ελέγχουμε με τα ρελέ την λειτουργία των κινητήρων, ανάλογα με την κατεύθυνση που θέλουμε να κινηθούμε.
...
Δοκιμάζουμε την λειτουργικότητα των μηχανικών μερών και κάνουμε κάποιες βελτιώσεις όπου νομίζουμε ότι θα λειτουργήσουν πιο αποτελεσματικά
...
Τέλος τοποθετούμε και τα ηλιακά πάνελ που παράγουν περίπου 15v τα οποία συνδέονται στην μπαταρία μέσω μιας διόδου για να φορτίζεται από τον ήλιο.
